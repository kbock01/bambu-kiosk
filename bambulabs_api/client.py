...
class Printer:
    ...
    def __init__(self, ip_address: str, access_code: str, serial: str, camera_enabled: bool):
    ...
    def camera_client_alive(self) -> bool:
        ...
        """
        return self.camera_client.alive if (self.camera_enabled) else False
    ...
    def get_sequence_id(self) -> int:
        ...
        Returns:
            int | None: The current sequence id
        """
        return self.mqtt_client.get_sequence_id()
