...
class PrinterMQTTClient:
    ...
    def info_get_version(self) -> bool:
        ...
        """
        return self.__publish_command({"info": {"sequence_id": str(self.get_sequence_id() + 1), "command": "get_version"}})
    ...
    def request_firmware_history(self):
        ...
        return self.__publish_command(
            {
                "upgrade": {"sequence_id": str(self.get_sequence_id() + 1), "command": "get_history"}
            }
        )
    ...
    def turn_light_off(self) -> bool:
        ...
        """
        return self.__publish_command({"system": {"sequence_id": str(self.get_sequence_id() + 1),
                                                  "command": "ledctrl",
        ...
        return self.__publish_command(
            {
                "print":
                {
                    "sequence_id": str(self.get_sequence_id() + 1),
    ...
    def stop_print(self) -> bool:
        ...
        Returns:
            str: print_status
        """
        return self.__publish_command({"print": {"sequence_id": str(self.get_sequence_id() + 1), "command": "stop", "param": ""}})
    ...
    def pause_print(self) -> bool:
        ...
        if self.get_printer_state() == GcodeState.PAUSE:
            return True
        return self.__publish_command({"print": {"sequence_id": str(self.get_sequence_id() + 1), "command": "pause", "param": ""}})
    ...
    def resume_print(self) -> bool:
        ...
        if self.get_printer_state() == GcodeState.RUNNING:
            return True
        return self.__publish_command({"print": {"sequence_id": str(self.get_sequence_id() + 1), "command": "resume", "param": ""}})
    ...
    def __send_gcode_line(self, gcode_command: str) -> bool:
        ...
        """
        return self.__publish_command({"print": {"sequence_id": str(self.get_sequence_id() + 1),
                                                 "command": "gcode_line",
    ...
    def request_access_code(self):
        ...
        """
        return self.__publish_command({
            "system": {"sequence_id": str(self.get_sequence_id() + 1), "command": "get_access_code"}
        })
    ...
    def set_auto_step_recovery(self, auto_step_recovery: bool = True) -> bool:
        ...
        """
        return self.__publish_command({"print": {"sequence_id": str(self.get_sequence_id() + 1), "command": "print_option", "auto_recovery": auto_step_recovery}})
    ...
    def set_print_speed_lvl(self, speed_lvl: int = 1) -> bool:
        ...
        """  # noqa
        return self.__publish_command({"print": {"sequence_id": str(self.get_sequence_id() + 1), "command": "print_speed", "param": f"{speed_lvl}"}}
        )
